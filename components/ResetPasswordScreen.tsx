...
import { Lock, AlertTriangle, ArrowLeft, Loader2, ShieldCheck, Zap, Fingerprint, CheckCircle } from 'lucide-react';
...
const ResetPasswordScreen: React.FC<ResetPasswordScreenProps> = ({ oobCode, onBackToLogin }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error('Lỗi xác nhận reset mật khẩu', err);
            if (err.code === 'auth/expired-action-code') {
                setError('Link reset mật khẩu đã hết hạn. Vui lòng yêu cầu lại.');
                    ...
                    <div className="p-10 md:p-12">
                        ...
                        <div className="flex flex-col items-center mb-10">
                            ...
                            <h1 className="text-2xl font-black text-[#102d62] tracking-tight uppercase font-head">
                                RESET <span className="text-[#01ccff]">PASSWORD</span>
                            </h1>
                            ...
                            <div className="space-y-8 animate-in zoom-in-95">
                                <div className="p-6 bg-emerald-50 border border-emerald-100 rounded-[2rem] flex flex-col items-center text-center gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <h3 className="text-emerald-900 font-black uppercase text-sm tracking-wider">Thành công!</h3>
                                ...
                                >
                                    ĐĂNG NHẬP NGAY <Zap size={18} className="fill-white" />
                                </button>
                            </div>
                        ) : (
                            <>
                                ...
                                <p className="text-slate-500 text-[13px] font-bold leading-relaxed text-center mb-8 px-4">
                                    Vui lòng tạo mật khẩu mới an toàn để tiếp tục truy cập vào hệ thống.
                                </p>
                                    ...
                                    <div className="pt-2 space-y-4">
                                        ...
                                        >
                                            {isLoading ? (
                                                ...
                                                <>
                                                    Xác nhận thay đổi <Zap size={18} className="fill-white" />
                                                </>
                                            )}
                                        </button>
